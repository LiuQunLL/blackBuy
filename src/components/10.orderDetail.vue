    ...
    <div class="right-auto orderDetail">
        <div class="bg-wrap" style="min-height: 765px;">
            ...
            <div class="form-box accept-box form-box1">
                ...
                <dl class="form-group">
                    <dt>快递单号：{{orderinfo.express_no}}</dt>
                </dl>
                <dl class="form-group">
                    <dt>支付方式：</dt>
...
export default {
  ...
  methods:{
    //点击确认收货
      receiveGoods(){
              ...
              //确认
               .then(()=>{
                    //调出确认接口
                     this.$axios.get(`http://111.230.232.110:8899/site/validate/order/complate/${this.orderId}`)
                     .then(result=>{
                         console.log(result);
    ...
    getOrderInfo(){
           // 调用接口
        this.$axios.get(`http://111.230.232.110:8899/site/validate/order/getorderdetial/${this.orderId}`)
    .then(result=>{
    //   console.log(result);
